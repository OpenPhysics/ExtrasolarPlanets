...
const REPLACEMENTS: ReadonlyArray<[string, string]> = [
  ...
  ["ExtrasolarPlanetsScreenSummaryContent", `${newPrefix}ScreenSummaryContent`],
  ["ExtrasolarPlanetsKeyboardHelpContent", `${newPrefix}KeyboardHelpContent`],
  ["ExtrasolarPlanetsPreferencesModel", `${newPrefix}PreferencesModel`],
  ["ExtrasolarPlanetsPreferencesNode", `${newPrefix}PreferencesNode`],
  ["ExtrasolarPlanetsScreenView", `${newPrefix}ScreenView`],
  ["ExtrasolarPlanetsColors", `${newPrefix}Colors`],
  ["ExtrasolarPlanetsNamespace", `${newPrefix}Namespace`],
  ["ExtrasolarPlanetsScreen", `${newPrefix}Screen`],
  ["ExtrasolarPlanetsModel", `${newPrefix}Model`],
  // camelCase identifier
  ["extrasolarPlanetsQueryParameters", `${newCamel}QueryParameters`],
  // Display strings
  ["Extrasolar Planets", newName],
  // Kebab identifiers (path segments and package name)
  ["extrasolar-planets", newId],
  ["extrasolar-planets-screen", `${newId}-screen`],
];
...
console.log(`  id:     extrasolar-planets → ${newId}`);
console.log(`  name:   Extrasolar Planets → ${newName}`);
