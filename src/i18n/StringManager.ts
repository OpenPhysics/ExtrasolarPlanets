...
export class StringManager {
  ...
  public getScreenNames(): {
    readonly radialVelocityStringProperty: ReadOnlyProperty<string>;
    readonly transitStringProperty: ReadOnlyProperty<string>;
  } {
    return {
      radialVelocityStringProperty: stringProperties.screens.radialVelocityStringProperty,
      transitStringProperty: stringProperties.screens.transitStringProperty,
    };
  }
   ...
   */
  public getRadialVelocityA11yStrings() {
    return stringProperties.a11y.radialVelocity;
  }

  public getTransitA11yStrings() {
